...
class VirtueMartViewCart extends VmView {
	...
	public function display($tpl = null) {
		...
		foreach($cart->products as $i)	{
			$manuf_ids[] = $i->virtuemart_manufacturer_id;
		}
		$manufacturers = VmModel::getModel('manufacturer');
		//echo"<pre>";print_r($manuf_ids);echo"</pre>";
		$manufacturers_arr = $manufacturers->getManufacturersFromIds((implode($manuf_ids, ',')));
		//echo"<pre>";print_r($manufacturers_arr);echo"</pre>";
		$this->assignRef('manufacturers_arr', $manufacturers_arr);
		//-----------------------------------------------------------
