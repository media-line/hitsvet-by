...
//<![CDATA[
	jQuery(document).ready(function($) {
		var max_height = 0;
		$('.products_from_cat h3').each(function() {
			if($(this).height() > max_height)	{
				max_height = $(this).height();
			}
		});
		$('.products_from_cat h3').css('height', max_height);
	});
//]]>
");
...
<div class="productdetails-view productdetails">
	...
	*/
    ...
    <?php // Product Title   ?>
    <h1><span><?php echo $this->product->product_name ?></span></h1>
...
//		}  // Add To Cart Button END
			...
			//echo'<pre>';print_r($this->product->product_in_stock);echo'</pre>';		    
			switch($this->product->product_in_stock)	{
				case -1:
					echo '<span class="in_stock_status">Под заказ</span>';
					break;
				case 0:
					echo '<span class="in_stock_status">Нет на складе</span>';
					break;
				default:
					echo $this->loadTemplate('addtocart');
			}
...
if (VmConfig::get('ask_question', 0) == 1) {
	...
	*/
	...
	//4436-1,01
	//echo'<pre>';print_r($this->product->customfieldsRelatedProducts[0]);echo'</pre>';
	//echo'<pre>';print_r($this->products_from_cat[0]);echo'</pre>';
	...
	if(count($this->products_from_cat) > 0)	{
		echo $this->loadTemplate('productsfromcat');
	}
    ?>
