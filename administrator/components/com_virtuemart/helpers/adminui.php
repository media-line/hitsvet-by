	...
	static function showAdminMenu() {
		...
		foreach ( $menuItems as $item ) { ?>
			...
			<div class="menu-list">
				...
				?>
				<?if($item ['title'] == 'COM_VIRTUEMART_PRODUCT_MOD')	{?>
					<?	//<li><a href="index.php?option=com_virtuemart&view=exportproducts"><span class="vmicon vmicon-16-pictures"></span>Файлы Экспорта</a></li> ?>
					<li><a href="index.php?option=com_virtuemart&view=importproducts"><span class="vmicon vmicon-16-pictures"></span>Обновить цены</a></li>
				<?	}	?>
