...
FancyUpload3.Attach.File = new Class({
	...
	render: function() {
		...
		var progress = new Element('img', {'class': 'file-progress', src: 'components/com_virtuemart/assets/fancyupload/assets/progress-bar/bar.gif'}).inject(this.ui.size, 'after');
